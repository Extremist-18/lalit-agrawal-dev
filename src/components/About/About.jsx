            ...
            <div className="AboutCard">
                ...
                <div className="About-content">
                    <div className="About-left">
                        ...
                        <ul className="points">
                            <li><a href="https://codeforces.com/profile/Lalit_Agrawal" target="_blank" className="anchor">CodeChef</a>: Specialist (Max:1583) &amp; <a href="https://atcoder.jp/users/Lalit18" target="_blank" className="anchor">AtCoder</a>: 4Kyu (Max:1232) </li>
                            <li> <a href="https://www.codechef.com/users/lalit_agrawal" target="_blank" className="anchor">CodeChef</a>: 3 Star (Max:1719) &amp; <a href="https://leetcode.com/u/Lalit__Agrawal/" target="_blank" className="anchor">Leetcode</a>: Knight (Max:1966) </li>
